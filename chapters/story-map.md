...
flowchart LR
  subgraph era [시대 전환]
    E1[코드 생성 도구 시대] --> E2[협업 시스템 재설계 시대]
  end
```
...
단일 도구 활용을 넘어, 여러 인간과 에이전트로 이루어진 팀과 프로세스를 어떻게 설계할지가 핵심이 됩니다. 이 배경을 염두에 두고 발표 흐름을 보겠습니다.
-->
...
발표 내용은 위 두 자료를 기반으로 했습니다. 
먼저 실무 쪽, No Vibes Allowed 발표 영상의 관련 내용을 공유드리겠습니다.
-->
